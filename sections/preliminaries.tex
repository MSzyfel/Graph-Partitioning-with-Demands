...
For a subset $C\subseteq E$ and a function $f$ on the edge set, $f\br{C}=\sum_{uv\in C}f\br{u,v}$. See Figure \ref{fig:demand-decomposition} for an illustration of this.
