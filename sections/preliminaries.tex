...
Whenever $A, B\subseteq V$ are not disjoint, we define $f\br{A, B}=f\br{A}+f\br{A, B\setminus A}$. See Figure \ref{fig:demand-decomposition} for an illustration of this.
