...
% We define the demand \emph{cut} by a subset of edges $C\subseteq E$ to be the sum of all $w(u,v)$ such that $u$ and $v$ belong to different connected components of $G\setminus C$.
